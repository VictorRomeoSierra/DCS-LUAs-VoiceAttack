...
ctld.cratesRequiredForFOB = 8 -- The amount of crates required to build a FOB. Once built, helis can spawn crates at this outpost to be carried and deployed in another area.
...
ctld.pickupZones = {
    ...
    { "CV1", "blue", 10, "yes", 0, 1001 }, -- instead of a Zone Name you can also use the UNIT NAME of a ship
}

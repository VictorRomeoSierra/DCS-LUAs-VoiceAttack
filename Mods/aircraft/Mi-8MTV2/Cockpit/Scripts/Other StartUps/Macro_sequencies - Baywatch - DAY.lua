...
-- · VRS Quick Start · Mi-8MTV2 (Baywatch - Day) ·
...
push_start_command(dt, {message = _("· VRS · Quick Start · Mi-8MTV2 (Baywatch - Day) ·"), message_timeout = 120})
...
-- Reserve - Set To 840kHz

push_start_command(dt, {device = devices.ARC_9, action = device_commands.Button_6, value = 0.4}) -- ARC 9 10KHZ DIAL
push_start_command(dt, {device = devices.ARC_9, action = device_commands.Button_5, value = 0.35}) -- ARC 9 100KHZ DIAL
...
push_start_command(dt, {message = _("Altimeter Set To FARP BAYWATCH"), message_timeout = 100})
push_start_command(dt, {message = _("Radio Set To ICS To Allow Rearm And Refuel"), message_timeout = 100})
push_start_command(dt, {message = _("Rocket Systems ON, Master Arm OFF"), message_timeout = 100})
push_start_command(dt, {message = _("Main ADF: FARP APEX (840kHz)"), message_timeout = 100})
push_start_command(dt, {message = _("Reserve ADF: FARP BAYWATCH (450kHz)"), message_timeout = 100})
...
push_start_command(dt, {message = _("    APEX     840kHz · 16nm 267 W"), message_timeout = 100})
...
push_start_command(1.0, {message = _("Stabilizing Engine RPM"), message_timeout = 14})
...
push_start_command(dt, {message = _("· VRS · Quick Start Complete · Mi-8MTV2 (Baywatch - Day) ·"), message_timeout = 10})
...
push_stop_command(dt, {message = _("· VRS · Quick Stop · Mi-8MTV2 (Baywatch - Day) ·"), message_timeout = 52})
...
push_stop_command(dt, {message = _("· VRS · Quick Stop Complete · Mi-8MTV2 (Baywatch - Day) ·"), message_timeout = mto})
end
doStopSequence()